\section{Circular RNAs (\gls{crna}s)}
\label{sec:circrnas}
...
Initially considered mere byproducts of \gls{mrna} splicing, \gls{crna}s have
...
\gls{crna}s are generated through two primary models of
...
In contrast, the lariat-intermediate model posits that \gls{crna}s can also
...
\begin{figure}[ht]
    ...
    \caption{Splicing of \gls{crna}s} % TODO: Add detailed caption
    \label{fig:circrna_splicing}
\end{figure}

\subsection{\gls{crna} types}
...
\paragraph{\Gls{ig-crna}} are formed from regions of
the
genome
...
The study of \gls{ig-crna}s is still in its infancy, and further research is
...
This mechanism involves the binding of \gls{crna}s to specific \gls{mirna}s,
thereby preventing these \gls{mirna}s from interacting with their target
\gls{mrna}s.
...
Beyond \gls{mirna} sponging, \gls{crna}s also participate in protein
interactions.
...
discovered that certain viral and cellular \gls{mrna}s contain sequences
