...
\begin{figure}[H]
    ...
    \caption{Overview of the two studies and their respective timelines.
        Each row represents two cohorts of mice: one with the modification to
        overexpress Esr1 and one with the modification to overexpress CYP19A1.
        The green arrows indicate healthy mice.
        The blue blocks indicate the period of doxycycline treatment to induce the
        transgenes.
        The red lines represent the times at which the mice were euthanized for tissue
        collection.
