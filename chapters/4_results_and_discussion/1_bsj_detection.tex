...
\begin{figure}[ht]
    ...
    \includegraphics[width=0.7\textwidth]{chapters/4_results_and_discussion/figures/detection/upset/shift_0.png}
...
\begin{figure}[ht]
    ...
    \caption{Stacked bar plot showing the level of agreement between tools for
        ...
        detected by 4-5 tools remains pretty much constant.
    }
