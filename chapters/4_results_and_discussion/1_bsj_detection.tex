...
\noindent\fbox{
    \parbox{\textwidth}{
        From now on, I will use the following filtering criteria:
        \begin{itemize}
            \item Clusters are formed by grouping \gls{bsj}s with a shift of 1
                  bp and ignoring the strand information
            \item Only \gls{bsj}s within clusters supported by at least four
