    ...
    \begin{tabular}{cc}
        \multicolumn{2}{c}{
            \begin{subfigure}{\textwidth}
                ...
                \caption{Schematic illustrating the terminology for the
                    following
                    plot.}
...
In order to investigate this further, I investigated the ratio between the
...
While there are a few clusters with a low ratio of 20 or lower, the majority of
