...
and \gls{cex2} detect a similar number of \glspl{bsj}, while \gls{segemehl} detects
...
\begin{figure}[H] \centering
    ...
    \caption{Number of \glspl{bsj} detected by each tool.
        ...
        number of \glspl{bsj}, \gls{segemehl} detects a much larger number of \glspl{bsj}.
    }
    \label{fig:detection_bars}
\end{figure}
Similar behavior was previously observed by \textcite{zeng_comprehensive_2017},
where \gls{segemehl} was among the top performers in terms of sensitivity, but also
