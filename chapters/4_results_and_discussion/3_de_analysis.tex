...
\begin{table}[H] \centering \begin{tabular}{cccc} \hline Location & Host gene
...
In the following sections, I will refer to these three \glspl{crna} using their
host gene names: \textit{Csn1s2a}, \textit{Csn1s1}, and \textit{Bbs9}.
