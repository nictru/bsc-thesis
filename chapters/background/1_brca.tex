...
\begin{table}[ht]
    ...
    \caption{Characteristics of breast cancer
        subtypes\supercite{clusan_basic_2023}}
\end{table}
...
\paragraph{Hormonal influences} are critical in breast cancer development.
...
\begin{figure}[ht]
    ...
    \includegraphics[width=0.5\textwidth]{chapters/background/figures/risk-factors.png}
    \caption{Risk factors for breast cancer. Currently taken from
    \cite{clusan_basic_2023}. Will be replaced with a self-made figure.}
