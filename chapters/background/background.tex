...
\paragraph{Internal ribosome entry site (IRES)-dependent mechanism}
...
\paragraph{N\textsuperscript{6}-methyladenosine
    (m\textsuperscript{6}A)-dependent mechanism}
m\textsuperscript{6}A is the most abundant base modification in
RNA \supercite{yang_extensive_2017}. Research has shown that a single
m\textsuperscript{6}A modification in circRNAs can be enough to initiate
translation \supercite{yang_extensive_2017}. Furthermore, consensus motifs for
m\textsuperscript{6}A modification have been identified to be enriched in
circRNAs \supercite{yang_extensive_2017}.
